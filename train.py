...
parser.add_argument("--n", type=str, default='ThinkingTwice', help="name")
parser.add_argument("--train_dataset", type=str, default='./traindataset', help="train dataset")
parser.add_argument("--train_instances", type=str, default='./traininstances', help="train instances")
...
train_dataset=COCODataset(opt.train_dataset,opt.train_instances,transform=transform)
...
for epoch in range(EPOCHS):
    for epoch_step,data in enumerate(train_loader):
        ...
        GLOBAL_STEPS+=1
    torch.save(model.state_dict(),"./"+opt.n+"/model_{}.pth".format(epoch+1))
